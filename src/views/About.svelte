  ...
  <div class="mt-20 w-4/5 mx-auto text-neutral-200 text-lg font-semibold text-left">
    ...
    <p class="mt-4">
      ...
      <p class="mt-4">
        ...
        <p class="mt-4">Current project is one of such index pages. It is based on the <a class="text-blue-400 hover:text-blue-500" href="https://instances.joinpeertube.org/instances" target="_blank">official list</a> of instances maintained by Framasoft. Peertuber is an open source project, collaboration is appreciated. The working repository could be found <a class="text-blue-400 hover:text-blue-500" href="https://github.com/acdmft/peertuber-front" target="_blank">here.</a></p>
  </div>
</div>