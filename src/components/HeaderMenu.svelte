...
<div bind:this={menu}>
  ...
  on:keypress={()=>{menuOpened=true}}
    ...
    class="text-neutral-300 hover:text-neutral-200 hover:cursor-pointer text-sm md:text-xl p-2"
  >
  ...
  >
    ...
    >
      <a
        ...
        class="block py-2 px-2 hover:bg-gray-700">Home page</a
      >
      {#if $user}
        <a
          href="/watchlater"
          ...
          class="block py-2 px-2 hover:bg-gray-700">Watch later</a
        >
        <a
          href="/liked"
          on:click={() => {
          ...
          class="block py-2 px-2 hover:bg-gray-700">Liked</a
        >
        <a
          href="/library"
          on:click={() => {
          ...
          class="block py-2 px-2 hover:bg-gray-700">Library</a
        >
      {/if}
      <a
        href="/contact"
        ...
        class="block py-2 px-2 hover:bg-gray-700">Contact</a
      >
      <a
        href="/about"
        on:click={() => {
