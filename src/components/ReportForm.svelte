      ...
      <form on:submit|preventDefault={reportVideo}>
        ...
        <div class="mt-2">
          <input
            ...
            value={"discr"}
          />
          <label class="ml-2" for="discr">Hateful, discriminatory content</label
          >
        </div>
        ...
        <div class="my-4 flex justify-around">
          <button on:click class="text-neutral-200 hover:text-red-200">Cancel</button>
          {#if btnDisabled}
            <button class="text-slate-600" disabled type="submit">Report</button
            >
          {:else}
